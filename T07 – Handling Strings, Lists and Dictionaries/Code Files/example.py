...
# is crucial.
# We have already touched on this subject in the previous strings task,
# so this will just serve as a brief recap and will introduce
# you to more ways to use string manipulation techniques.
...
# Notice how a list is printed out? This is import to note as the split()
# method will return a list of the split string.
